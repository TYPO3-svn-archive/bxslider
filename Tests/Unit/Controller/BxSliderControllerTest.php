...
/**
 * Test case for class Tx_Bxslider_Controller_BxSliderController.
 *
 * @version $Id$
 ...
 */
class Tx_Bxslider_Controller_BxSliderControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
